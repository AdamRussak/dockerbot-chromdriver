...
COPY forms-automation-cli.py /etc/forms-automation-cli.py
COPY forms-demo.py /etc/forms-demo.py
COPY dockerbot.py /opt/dockerbot

RUN echo 'export PATH="/opt/chromedriver-83.0.4103.39":$PATH' >> /root/.bashrc && chmod 777 /etc/forms-automation-cli.py
